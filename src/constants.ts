    ...
    questions: [
      {
        ...
        sampleAnswer: 'Well, let me think... I was born and raised in [[Hanoi]], the capital city of Vietnam. It\'s a [[vibrant metropolitan area]] known for its [[rich history]] and [[delicious street food]].',
      ...
      },
      {
        ...
        sampleAnswer: 'To be honest, what I love most is the atmosphere, especially in the Old Quarter. There\'s a [[unique blend]] of [[ancient architecture]] and [[modern lifestyle]] that you can\'t find elsewhere.',
    ...
    questions: [
      {
        ...
        sampleAnswer: 'Actually, I\'m a final-year student majoring in International Business. I find it quite challenging but extremely rewarding at the same time.',
      ...
      },
      {
        ...
        sampleAnswer: 'Well, I really enjoy the practical aspects of my course. We get to work on real-life case studies, which helps me understand how global markets actually function.',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        sampleAnswer: 'Well, I try to dedicate at least an hour every evening to my hobbies. On weekends, I might spend even more time if I don\'t have any pressing commitments.',
...
export const PART_2_CUE_CARDS: Part2CueCard[] = [
  {
    ...
    sampleAnswer: 'Intro: Well, today I\'d like to talk about my high school teacher, Mr. Nam.\n\nContext: [[If my memory serves me right]], Mr. Nam was tall and slim, who was [[very supportive]] and friendly to students. You know, I first met him when I was a [[struggling tenth grader]] who couldn\'t understand basic math.\n\nStory: Basically, at that time, I was [[almost failing]] the subject because I didn\'t get almost anything about maths. However, Mr. Nam [[spent extra hours]] explaining concepts using [[real-world examples]]. Eventually, I not only passed but [[became top of my class]]. Today, I\'m [[pursuing an engineering degree]] thanks to him.\n\nConclusion: What I\'m trying to say is, through this experience, I feel [[very grateful]] and I really hope I can visit him soon to show my gratitude.',
  ...
  p2_1: [
    {
      ...
      sampleAnswer: 'Well, [[in my view]], a good role model should possess [[integrity and resilience]]. I mean, they need to [[lead by example]] and show others how to [[handle failure with grace]]. For instance, an athlete who overcomes a career-threatening injury through [[sheer determination]] can [[inspire countless youngsters]] to never give up on their dreams.',
    ...
    },
    {
      ...
      sampleAnswer: 'Honestly, I\'ve never thought about that before, but I think role models [[used to be limited to]] historical figures or family members. Nowadays, thanks to social media, anyone who shares [[inspiring content]] can become a role model. To illustrate, in the past, a child might\'ve [[looked up to]] a local hero, but today, a teenager might [[find inspiration from]] a tech entrepreneur on YouTube.',
